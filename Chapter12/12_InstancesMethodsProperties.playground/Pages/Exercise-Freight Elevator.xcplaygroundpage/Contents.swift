...
var ricketyRope: TreehousePulley = TreehousePulley(weightCapacity: 200)
var strongRope = TreehousePulley(weightCapacity: 20000)

ricketyRope.addLoadToBasket(loadWeight: snacks)
ricketyRope.canHandleAdditionalLoad(snacks)
