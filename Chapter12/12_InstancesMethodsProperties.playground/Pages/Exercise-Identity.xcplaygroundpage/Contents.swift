...
var myPlans: String = "I am going to work on swift."
var friendPlans = myPlans


// Update `myPlans` here:
myPlans += " And watch some TV."
friendPlans
...
func addDance(myPlans: String) -> String {
    let newPlan: String = " But we have to dance too!"
    return myPlans + newPlan
}
friendPlans = addDance(myPlans: myPlans)
friendPlans
