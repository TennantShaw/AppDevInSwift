...
let favoriteFood = makeFavorite(categoryOfThing: "food", favorite: "Pizza")
let favoriteMovie = makeFavorite(categoryOfThing: "movie", favorite: "Labrynth")
let favoriteBand = makeFavorite(categoryOfThing: "band", favorite: "MiMoSa")
...
print("Hello, my name is Tennant. \(favoriteFood) \(favoriteBand) \(favoriteMovie) What are your's?")
