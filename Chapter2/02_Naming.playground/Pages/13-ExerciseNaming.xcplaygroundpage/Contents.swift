...
let numberOfOrangeCases = 14
let numberOfWatermelonCases = 3
let orangeWeight = 100
let watermelonWeight = 200
let totalOrageWeight = numberOfOrangeCases * orangeWeight
let totalWatermelonWeight = numberOfWatermelonCases * watermelonWeight
let totalWeight = totalOrageWeight + totalWatermelonWeight
let extraSpace = totalWeight / 2
let leftSideSpace = extraSpace / orangeWeight
let rightSideSpace = numberOfOrangeCases - leftSideSpace
