...
let suitOfSpades = Suit.spades.suitEmoji
let suitOfHearts = Suit.hearts.suitEmoji
let suitOfDiamonds = Suit.diamonds.suitEmoji
let suitOfClubs = Suit.clubs.suitEmoji
