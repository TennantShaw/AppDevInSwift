 ...
 */
var beachChoice = [Int]()
var chocolateFactoryChoice = [Int]()

for votes in tripDestinationVotes {
    if votes == .beach {
        beachChoice.append(1)
    } else {
        chocolateFactoryChoice.append(1)
    }
}
 ...
 */
var marmotVotes = [Int]()
var salamanderVotes = [Int]()
var neitherVotes = [Int]()

func tallyVotes(forIssue: String, withVotes: [SchoolMascotOption]) {
    for vote in withVotes {
        if vote == .marmot {
            marmotVotes.append(1)
        } else if vote == .salamander {
            salamanderVotes.append(1)
        } else {
            neitherVotes.append(1)
        }
    }
}
