...
let positiveEmotion = "fucking stoked"
let negativeEmotion = "fucking pissed"

let madLibString = "Today was a big day for \(name). They had finally saved up \(number) dollars and were going to buy an \(adjective) \(noun). They went to the \(noun) \(place) feeling very \(positiveEmotion). But then they felt \(negativeEmotion). They were all out of \(noun)s!"
