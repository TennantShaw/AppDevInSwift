 ...
 */
let iPhoneCapacityInGB = 8
let availableIPhoneCapacityInGB = 5
let iPhoneCapacityInMB = iPhoneCapacityInGB * 1000
let availableCapacityInMB = availableIPhoneCapacityInGB * 1000
let oneMinuteVideoRequiredSpaceInMB = 150
let availableCapacityForVideo = availableCapacityInMB / oneMinuteVideoRequiredSpaceInMB

let toUser = "You can record \(availableCapacityForVideo) more minutes of video."
